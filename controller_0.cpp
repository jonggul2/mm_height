...
int main(void)
{
    ...
    // All speeds in m/s
    float simulation_run_fwrd_speed = 1.0f;
    float simulation_run_side_speed = 0.8f;
    ...
    auto update_func = [&]()
    {
        ...
        GuiGroupBox((Rectangle){ 970 + 1140, ui_inert_hei, 290, 40 }, "inertiaization blending");

        GuiSliderBar(
            (Rectangle){ 1100 + 1140, ui_inert_hei + 10, 120, 20 }, 
            "halflife", 
        ...
        GuiGroupBox((Rectangle){ 970 + 1140, ui_lmm_hei, 290, 40 }, "learned motion matching");

        GuiCheckBox(
            (Rectangle){ 1000 + 1140, ui_lmm_hei + 10, 20, 20 }, 
            "enabled",
            &lmm_enabled);
        ...
        GuiGroupBox((Rectangle){ 1010 + 1140, ui_ctrl_hei, 250, 140 }, "controls");

        GuiLabel((Rectangle){ 1030 + 1140, ui_ctrl_hei +  10, 200, 20 }, "Left Trigger - Strafe");
        GuiLabel((Rectangle){ 1030 + 1140, ui_ctrl_hei +  30, 200, 20 }, "Left Stick - Move");
        GuiLabel((Rectangle){ 1030 + 1140, ui_ctrl_hei +  50, 200, 20 }, "Right Stick - Camera / Facing (Stafe)");
        GuiLabel((Rectangle){ 1030 + 1140, ui_ctrl_hei +  70, 200, 20 }, "Left Shoulder - Zoom In");
        GuiLabel((Rectangle){ 1030 + 1140, ui_ctrl_hei +  90, 200, 20 }, "Right Shoulder - Zoom Out");
        GuiLabel((Rectangle){ 1030 + 1140, ui_ctrl_hei + 110, 200, 20 }, "A Button - Walk");
